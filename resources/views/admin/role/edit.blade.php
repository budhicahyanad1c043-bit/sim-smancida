            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('admin.role.update', $role->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" value="{{ old('name', $role->name) }}" class="w-full border-gray-300 rounded-md shadow-sm" required>
                    ...
                    <div class="flex justify-end gap-2">
                        ...
                        <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">Perbarui Role</button>
                    </div>
                </form>
            </div>
        </div>
