        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('admin.guru.store') }}" method="POST">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 border-b pb-2 mb-4">Informasi Akun & Utama</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label class="block text-gray-700 font-bold mb-2">Email (Untuk Login) <span class="text-red-500">*</span></label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="nip" value="{{ old('nip') }}" maxlength="18" class="w-full border-gray-300 rounded-md shadow-sm">
                            @error('nip') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label class="block text-gray-700 font-bold mb-2">NIK</label>
                            <input type="text" name="nik" value="{{ old('nik') }}" maxlength="16" class="w-full border-gray-300 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="nuptk" value="{{ old('nuptk') }}" maxlength="16" class="w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir') }}" class="w-full border-gray-300 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="date" name="tgl_lahir" value="{{ old('tgl_lahir') }}" class="w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="alamat" class="w-full border-gray-300 rounded-md shadow-sm" rows="2">{{ old('alamat') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="desa" value="{{ old('desa') }}" class="w-full border-gray-300 rounded-md shadow-sm">
                        </div>

                        <div>
                            <label class="block text-gray-700 font-bold mb-2">Kecamatan</label>
                            <input type="text" name="kecamatan" value="{{ old('kecamatan') }}" class="w-full border-gray-300 rounded-md shadow-sm">
                        </div>

                        <div>
                            <label class="block text-gray-700 font-bold mb-2">Kabupaten/Kota</label>
                            <input type="text" name="kabupaten" value="{{ old('kabupaten') }}" class="w-full border-gray-300 rounded-md shadow-sm">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <input type="text" name="provinsi" value="{{ old('provinsi') }}" class="w-full border-gray-300 rounded-md shadow-sm">
                        </div>

                        <div>
                            <label class="block text-gray-700 font-bold mb-2">Kode Pos</label>
                            <input type="text" name="kode_pos" value="{{ old('kode_pos') }}" class="w-full border-gray-300 rounded-md shadow-sm">
                        </div>
                    </div>
